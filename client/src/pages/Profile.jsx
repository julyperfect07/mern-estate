...
const Profile = () => {
  ...
  const handleListingDelete = async (listingId) => {
    try {
      ...
      if (!res.ok) {
        console.error(`Failed to delete listing. Status: ${res.status}`);
        return;
      }
  ...
  return (
    <div className=' p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className=' flex flex-col gap-4' >
        ...
        <img onClick={() => fileRef.current.click()} className=' rounded-full h-24 w-24 object-cover cursor-pointer self-center' src={formData.avatar ||currentUser.avatar} alt="" />
